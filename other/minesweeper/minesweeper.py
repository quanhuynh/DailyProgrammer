...
class Minesweeper():
	def __init__(self, master, width=10, height=10):
		...
		self.numbersImg = {0:PhotoImage(file="img/0.png"),1:PhotoImage(file="img/1.png"), 2:PhotoImage(file="img/2.png"),3:PhotoImage(file="img/3.png"),4:PhotoImage(file="img/4.png"),5:PhotoImage(file="img/5.png"),6:PhotoImage(file="img/6.png"),7:PhotoImage(file="img/7.png"),8:PhotoImage(file="img/8.png")}
